-- First things first, the <leader> key
vim.g.mapleader = " "
...
vim.opt.breakindent = true -- Enable brack indent
vim.opt.undofile = true -- Save undo tree to file
vim.opt.ignorecase = true -- Case insensitive search
vim.opt.smartcase = true -- Enable case sensitivity if a capital letter is present in the query
vim.opt.signcolumn = "yes" -- Sign column always shown
vim.opt.inccommand = "split" -- Substitution preview
vim.opt.cursorline = true -- Highlight curosor line
vim.opt.scrolloff = 2 -- Lines always visible on top and bottom of the window
...
vim.keymap.set("n", "<A-j>", ":bn<CR>", { noremap = true, silent = true })
vim.keymap.set("n", "<A-k>", ":bp<CR>", { noremap = true, silent = true })
